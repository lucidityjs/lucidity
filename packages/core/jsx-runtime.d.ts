/**
 * JSX typedefs for Lucidity.
 * @module
 */

// deno-lint-ignore-file no-empty-interface
import type * as csstype from "npm:csstype@3.1.3";

/**
 * Based on Solid's JSX runtime (Lucidity is inspired by Solid, so this is easy!)
 * Solid is also MIT licensed! :)
 *
